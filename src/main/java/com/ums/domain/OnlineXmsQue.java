...
@Table(name="UMS_ONLINE_XMS_QUEUE")
public class OnlineXmsQue extends BaseOnlineChnQue implements Serializable {
    ...
    public OnlineSmsTransQue convertXmsToSms(OnlineXmsQue que) {
